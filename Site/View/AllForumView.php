    ...
    <div class="9u 12u(mobile) important(mobile)">
        <div class="content content-right">
            ...
            <article class="box post">
                <header>
                    <h2 class="major"><span><a href="#">Project 1 feed</a></span></h2>
                ...
                <ul class="meta">
                        <li class="icon fa-clock-o">last message 6 hours ago</li>
                        <li class="icon fa-comments"><a href="#">34</a></li>
                        <li><a href="#" class="button">View Feed</a></li>
                </ul>
            </article>
            <!--Display last messages-->
            <article class="box post">
                <header>
                    <h2 class="major"><span><a href="#">Project 2 feed</a></span></h2>
                </header>
                <p>
                    Phasellus quam turpis, feugiat sit amet ornare in, a hendrerit in lectus. Praesent
                    semper mod quis eget mi. Etiam sed ante risus aliquam erat et volutpat. Praesent a
            ...
            <article class="box post">
                <header>
                    <h2 class="major"><span><a href="#">Project 3 feed</a></span></h2>
                </header>
                <p>
                    Phasellus quam turpis, feugiat sit amet ornare in, a hendrerit in lectus. Praesent
                    semper mod quis eget mi. Etiam sed ante risus aliquam erat et volutpat. Praesent a
